...
// Posições de cada elemento no grid 18x7
// [period, group] — lantanídeos e actinídeos têm período especial (8 e 9)
...
export function PeriodicTable({ elements }: PeriodicTableProps) {
  ...
  // Constrói grade principal (7 períodos × 18 grupos)
